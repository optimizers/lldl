classdef opSymMatrix < opSpot
%OPSYMMATRIX   Convert a numeric matrix stored as its lower triangle
%              into a Spot operator.
%
%   opSymMatrix(A,DESCRIPTION) creates an operator that performs
...
%   http://www.cs.ubc.ca/labs/scl/spot
    ...
    methods
       ...
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
       function op = opSymMatrix(A, description)
       %opSymMatrix  Constructor.
          if nargin < 1
          ...
          if nargin < 2, description = 'SymMatrix'; end
